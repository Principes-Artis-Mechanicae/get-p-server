...
public record ClientResponse(@NotNull Long Id, @NotNull String nickname, @NotNull String email,
    ...
    public static ClientResponse from(Client client) {
        return new ClientResponse(client.getClientId(), client.getNickname(), client.getEmail(), client.getPhoneNumber(),
