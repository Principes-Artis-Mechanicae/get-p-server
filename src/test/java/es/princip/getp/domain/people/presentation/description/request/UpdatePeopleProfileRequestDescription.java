package es.princip.getp.domain.people.presentation.description.request;

import org.springframework.restdocs.payload.FieldDescriptor;

import static es.princip.getp.infra.util.FieldDescriptorHelper.getDescriptor;

public class UpdatePeopleProfileRequestDescription {

    public static FieldDescriptor[] description() {
        final Class<?> clazz = UpdatePeopleProfileRequestDescription.class;
