package es.princip.getp.domain.client.query.presentation.description;

import es.princip.getp.domain.client.command.presentation.description.AddressDescription;
import es.princip.getp.domain.client.command.presentation.description.BankAccountDescription;
