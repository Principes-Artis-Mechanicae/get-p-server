...
public class SliceResponseDescription {
    ...
    public static FieldDescriptor[] sliceResponseDescription() {
        return new FieldDescriptor[] {
            ...
            fieldWithPath("data.sliceInfo.cursor")
            ...
            fieldWithPath("data.sliceInfo.sort.property")
                .description("정렬 속성")
                .optional()
                .type(JsonFieldType.STRING),
            fieldWithEnum(Sort.Direction.class).withPath("data.sliceInfo.sort.direction")
                .description("정렬 방향")
                .optional()
        };
    }
